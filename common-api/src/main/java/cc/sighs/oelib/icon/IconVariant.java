package cc.sighs.oelib.icon;

import java.util.Objects;

public final class IconVariant {
    public enum Platform {COMMON, FABRIC, NeoForge}
    ...
    public static IconVariant nameNeoForge(String name, int weight) {
        return new IconVariant(Objects.requireNonNull(name), null, weight, Platform.NeoForge);
    }

    public static IconVariant pathNeoForge(String path, int weight) {
        return new IconVariant(null, Objects.requireNonNull(path), weight, Platform.NeoForge);
    }
    ...
    boolean appliesToNeoForge() {
        return platform == Platform.COMMON || platform == Platform.NeoForge;
    }
}