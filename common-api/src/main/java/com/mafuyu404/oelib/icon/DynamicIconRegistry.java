 ...
 * <p>
 * 该系统允许模组作者为 Fabric 和 Forge 分别指定不同的图标资源，并支持基于权重的随机选择。
 ...
 *   <li>{@link Builder#addNameForge(String, int)}：直接使用文件名作为路径，
 *       对应资源包根目录下的 {@code resources/<filename>}。</li>
 *   <li>若图标不在上述默认位置，请使用 {@link Builder#addPathFabric(String, int)} 或
 *       {@link Builder#addPathForge(String, int)} 指定完整相对路径（相对于 {@code resources/}）。</li>
 * </ul>
 *
 * <h4>注意</h4>
