 ...
 *
 * <p>Chains are registered via {@link #register(Identifier, int, Consumer)}
 * before configurations are loaded.
 */
public final class ConfigFixRegistry {
    private static final Map<Identifier, Chain> CHAINS = new LinkedHashMap<>();
     ...
     */
    public static void register(Identifier id, int currentVersion, Consumer<Builder> consumer) {
     ...
     */
    public static Optional<Chain> get(Identifier id) {
