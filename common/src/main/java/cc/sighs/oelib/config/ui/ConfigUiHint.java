...
public sealed interface ConfigUiHint permits ConfigUiHint.Slider, ConfigUiHint.Text, ConfigUiHint.Toggle,
     ...
     *
     * @param widgetId the identifier of the widget registered in
     ...
     */
    static Custom custom(Identifier widgetId, JsonObject args) {
     ...
     * {@link ConfigWidgetRegistry#register(Identifier, ConfigWidgetRegistry.CustomWidgetFactory)}.
     */
    record Custom(Identifier widgetId, JsonObject args) implements ConfigUiHint {
        public Custom {
