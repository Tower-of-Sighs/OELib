 ...
 * <ul>
 *   <li>By {@link Identifier} — a specific widget factory that is
...
public final class ConfigWidgetRegistry {
    private static final Map<Identifier, CustomWidgetFactory> CUSTOM_WIDGETS = new ConcurrentHashMap<>();
    ...
    /**
     * Registers a custom widget factory keyed by identifier.
     *
     * @param widgetId the widget identifier
     * @param factory  the factory
     */
    public static void register(Identifier widgetId, CustomWidgetFactory factory) {
        CUSTOM_WIDGETS.put(widgetId, factory);
    }

    /**
     * Looks up a custom widget factory by identifier.
     *
     * @param widgetId the widget identifier
     * @return the factory, or {@link Optional#empty()}
     */
    public static Optional<CustomWidgetFactory> custom(Identifier widgetId) {
    ...
    /**
     * Factory interface for creating custom widgets identified by an
     * {@link Identifier}.
     */
