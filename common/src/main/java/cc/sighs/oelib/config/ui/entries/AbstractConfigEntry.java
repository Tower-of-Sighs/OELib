 ...
 * {@link #render(GuiGraphicsExtractor, int, int, int, int, int, int, int, boolean, float)}
...
public abstract class AbstractConfigEntry<T> implements GuiEventListener, NarratableEntry {
     ...
     */
    public abstract void render(GuiGraphicsExtractor graphics, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean isHovered, float delta);
