...
public class DynamicEntryListWidget extends DynamicElementListWidget {
    /** The texture id for the vertical header separator. */
    public static final ResourceLocation VERTICAL_HEADER_SEPARATOR = new ResourceLocation(OELib.MODID, "textures/gui/menu_list_background.png");
