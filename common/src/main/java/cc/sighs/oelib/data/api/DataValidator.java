...
public interface DataValidator<T> {
     ...
     */
    ValidationResult validate(T data, Identifier source);
    ...
    interface ServerContextAware<T> extends DataValidator<T> {
         ...
         * @return the validation result
         */
        ValidationResult validateWithContext(T data, Identifier source, MinecraftServer server);
         ...
         */
        @Override
        default ValidationResult validate(T data, Identifier source) {
    ...
    class NoValidator implements DataValidator<Object> {
        @Override
        public ValidationResult validate(Object data, Identifier source) {
