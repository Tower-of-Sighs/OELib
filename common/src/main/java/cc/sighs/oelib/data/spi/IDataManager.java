...
public interface IDataManager {
    ...
    <T> Map<Identifier, T> getAllData(Class<T> dataClass);

    <T> T getData(Class<T> dataClass, Identifier location);
    ...
    <T> void updateClientData(Class<T> dataClass, Map<Identifier, T> data);

    void updateClientDataRaw(Class<?> dataClass, Map<Identifier, ?> data);
