...
import cc.sighs.oelib.registry.action.ListenAction;
...
public final class RegisterSupplier<T> implements Supplier<T> {
    ...
    public RegisterSupplier(ResourceKey<? extends Registry<T>> registryKey, Identifier id, Supplier<? extends T> creator) {
        ...
        this.getterRef.set(() -> {
            ...
            throw new IllegalStateException("Object is not registered yet: " + registryKey.identifier() + " " + id);
        });
    }
