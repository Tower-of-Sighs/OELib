...
public class CodecUtils {
    ...
    public static <T> Optional<String> encodeToJson(Class<T> dataClass, Map<Identifier, T> data) {
    ...
    public static <T> Optional<Map<Identifier, T>> decodeFromJson(Class<T> dataClass, String jsonData) {
    ...
    private static <T> Codec<Map<Identifier, T>> createMapCodec(Class<T> dataClass) {
        var codec = getCodec(dataClass);
        return Codec.unboundedMap(Identifier.CODEC, codec);
    }
