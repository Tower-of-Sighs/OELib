...
public class ShaderEvents {
    public static void register() {
        ShaderRegister.register(new ResourceLocation(OELibBless.MOD_ID, "chongyang"),
                DefaultVertexFormat.POSITION_TEX, ShaderToastResources::setSpiritToastShader);

        ShaderRegister.register(new ResourceLocation(OELibBless.MOD_ID, "new_year"),
                DefaultVertexFormat.POSITION_TEX, ShaderToastResources::setNewYearShader);

        ShaderRegister.register(new ResourceLocation(OELibBless.MOD_ID, "valentine"),
