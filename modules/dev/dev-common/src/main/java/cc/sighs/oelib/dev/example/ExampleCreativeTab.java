...
public class ExampleCreativeTab {
    public static final DeferredRegister<CreativeModeTab> TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, OELibDev.MOD_ID);

    public static final RegisterSupplier<CreativeModeTab> GENERAL = TABS.register("general", () ->
            CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0)
                    .title(Component.translatable("itemGroup.oelib_dev.general"))
